...
static void s_build_connect_request(struct aws_socks5_proxy_impl *impl) {
    ...
    aws_byte_buf_write_u8(&impl->write_buffer, SOCKS5_VERSION_VALUE);                // version byte
...
static void s_destroy_channel_handler_socks5(struct aws_l4_proxy_channel_handler *handler) {
    ...
    aws_mem_release(handler->allocator, socks5_handler);
}
...
static struct aws_l4_proxy_channel_handler *s_aws_l4_proxy_channel_handler_new_socks5(
    ...
    socks5_handler->base.impl = socks5_handler;
