...
int aws_secitem_import_trusted_certificates(
     ...
     */
    if (aws_pem_objects_init_from_file_contents(&decoded_cert_buffer_list, alloc, *certificates_blob)) {
    ...
    /* certificate_ref needs to be Released when done */
    *sec_root_ca = certificate_ref;
