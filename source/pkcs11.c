...
/* Support older Cryptoki versions, even if we're using later versions of the headers.
 * The API is designed to be forward compatible (PKCS11-base-v2.40 section 3.1) */
