...
static int s_test_event_loop_group_setup_and_shutdown (struct aws_allocator *allocator, void *user_data) {
...
static int s_test_event_loop_group_counter_overflow (struct aws_allocator *allocator, void *user_data) {
