...
AWS_IO_API int aws_l4_proxy_config_get_proxy_address(struct aws_l4_proxy_config *config, struct aws_socket_options *socket_options, struct aws_connection_remote *new_remote);
