 ...
 * Calling `aws_retry_strategy_acquire_retry_token` will return `AWS_IO_RETRY_PERMISSION_DENIED`. 
 * Calling any function apart from the `aws_retry_strategy_acquire_retry_token` and `aws_retry_strategy_release` will result in a fatal error.
 */
